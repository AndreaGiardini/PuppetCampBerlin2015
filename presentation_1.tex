...
\begin{frame}
    ...
    \begin{itemize}
        ...
        Environments are collections of modules and hostgroups at different development levels
    \end{itemize}
...
\begin{frame}
    ...
    \newline 
    \newline 
    Custom environment (for testing purpose):
    \begin{itemize}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \begin{itemize}
                    ...
                    \item Environments
                \end{itemize}
                A configuration change has to be approved through a request in Jira.
                \newline
                \newline
            ...
            \begin{column}{0.5\textwidth}
                \begin{center}
                    ...
                    \\[2em]
                    \includegraphics[width=0.85\textwidth]{{800px-JIRA_logo.svg}.png}
                \end{center}
            \end{column}
        \end{columns}
    \end{minipage}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{itemize}
                    ...
                    \item Ability to react to failure
                \end{itemize}
            \end{column}
        \end{columns}
    \end{minipage}
...
\begin{frame}
    \frametitle{Renaming Procedure}
    INSERT RENAMING IMAGE
\end{frame}
    ...
    \begin{minipage}[T]{0.95\textwidth}
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                Problems in the past with big clusters ( $\textgreater$ 3000 nodes) \\[2em]
